...
const projects = ref([
  ...
  {
    slug: "babylon-bahndienste",
    title: "Babylon Bahndienste GmbH",
    description: "Strategisches digitales Marketing, das Ergebnisse liefert.",
    image: Image2,
    icon: "👷🏻‍♂️",
  },
  {
    id: "goldpreise",
    title: "Goldpreise.net",
    description: "Eine leistungsstarke Web-Scraping-Lösung für Datenextraktion.",
    image: Image3,
    icon: "🥇",
  },
  {
    id: "santex",
    title: "Änderungsschneiderei Santex",
    description: "Lokalen Schneiderei ",
    image: Image4,
    icon: "🧵",
  },
]);
